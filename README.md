<div align="center">
    <img src="https://github.com/deta/limit-order-protocol/blob/master/.github/deta_github_w.svg#gh-light-mode-only">
    <img src="https://github.com/deta/limit-order-protocol/blob/master/.github/deta_github_b.svg#gh-dark-mode-only">
</div>

# deta Limit Order Protocol Smart Contract

[![Build Status](https://github.com/deta/limit-order-protocol/workflows/CI/badge.svg)](https://github.com/deta/limit-order-protocol/actions)
[![Coverage Status](https://codecov.io/gh/deta/limit-order-protocol/branch/master/graph/badge.svg?token=FSFTJPS41S)](https://codecov.io/gh/deta/limit-order-protocol)
...
Please, use the commit tagged `v2` ([here](https://github.com/deta/limit-order-protocol/releases/tag/v2)) to get the latest production version that has passed through a series of [security audits](https://github.com/deta/deta-audits/tree/master/Limit%20Order%20Protocol%20V2).

### About

You can find general overview and docs on deta limit orders protocol [here](https://docs.deta.io/docs/limit-order-protocol/introduction/).

This repository contains a smart contract for EVM based blockchains (Ethereum, Binance Smart Chain, etc.), this contract is core part of deta limit order protocol.
...
### Deployments & audits:
You can find deta limit order protocol deployments here: 
...
You can find audit reports on etherscan and in the separate [audit repository](https://github.com/deta/deta-audits/tree/master/Limit%20Order%20Protocol). 


### Utils library
Plenty of utils that helps create & sign orders are available in our typescript utils library:  
- [deta Limit Order Utils](https://github.com/deta/limit-order-protocol-utils) 
